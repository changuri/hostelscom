...
//검색창 popup========================================================================= 
    ...
    $(window).scroll(function(){
      ...
      if(scrollTop>100){
          $('.main-search').css('transform','scale(1.1)');
          if($('body').hasClass('mobile')){
...
//실시간 게스트 이용후기 ===============================================================
  ...
  //실시간 게스트 이용후기 이미지 hover
    ...
    $('.geust img').on({
      mouseenter:function(){
        if($('body').hasClass('mobile')){        
          $(this).parent().find('.text-box').css('top','90%');
        }else{
...
// 취향저격 curation-room ============================================================
    var swiper5 = new Swiper('.curation-room .swiper-container', {
      ...
      navigation: {
          nextEl: '.curation-room .swiper-button-next',
          prevEl: '.curation-room .swiper-button-prev',
     },
  });
...
//   $('map').append('<div class="tooltip '+position+'">'+tooltipTitle+'</div>');

//   var x=Math.floor($(this).position().left);
//   var y=Math.floor($(this).position().top);

//   var btnW=Math.floor($(this).innerWidth());
//   var btnH=Math.floor($(this).innerHeight());  
...
//         top:y
//     })
//   }else if(position=='seoul'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='daejeon'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='gyeongi'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='kang'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='C-nam'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='C-buk'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='J-buk'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='J-nam'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='gwangu'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='daegu'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='woolsan'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='busan'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='K-buk'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })
//   }else if(position=='K-nam'){
//     $('.tooltip').css({
//         left:x,
//         top:y
//     })

...
//메인 페이지============================================================
    $(window).resize(function(){
      ...
      if(windowWidth <= 767){        
        ...
        $('.btn-tooltip').mouseleave(function(e){
          $('.tooltip').remove();
        })
...
//핫딜================================================================================== 
  ...
  //카운트 다운 time1 
  countDown('2019-08-30 18:00:00', '.countTime1', '.time1');
  countDown('aug 19, 2019 18:00:00', '.countTime2', '.time2');
  countDown('2019-09-01 18:00:00', '.countTime3', '.time3');
  function countDown(dday, selector1, selector2){
    ...
    $(selector1).text(`${days}일 ${hours}시간 ${minutes}분 ${seconds}초 `)
      
      if (distance < 0) {
        clearInterval(x);
        $(selector1).text('0일 0시간 0분 0초');
        $(selector2).addClass('off').text('핫딜종료');    
      }
    }, 1000);
  }
  //   //카운트 다운 time2
  // var time2 = new Date('aug 19, 2019 18:00:00').getTime();
  ...
  //   $('.countTime2').text(`${days2}일 ${hours2}시간 ${minutes2}분 ${seconds2}초 `)
      
  //     if (distance2 < 0) {
  //       clearInterval(x2);
  //       $('.countTime2').text('0일 0시간 0분 0초');    
  //       $('.time2').addClass('off').text('핫딜종료');      
  //     }
  //   }, 1000);

  //   //카운트 다운 time3
  // var time3 = new Date('aug 25, 2019 18:00:00').getTime();
  ...
  //   $('.countTime3').text(`${days3}일 ${hours3}시간 ${minutes3}분 ${seconds3}초 `)   
      
  //     if (distance3 < 0) {
  //       clearInterval(x3);
  //       $('.countTime3').text('0일 0시간 0분 0초');    
...
//실시간 게스트 이용후기 .geust ============================================================
  ...
  //실시간 게스트 이용후기 이미지 hover
    ...
    $('#widget').draggable();
    $( '.tab-content2-1 .draggable, .tab-content2-2 .draggable' ).draggable({ axis: "y", revert: true, containment: '.tab-content2-1 .swiper-slide', scroll: false } );   
...
//탑버튼=====================================================================
  ...
  $(window).scroll(function(){
    ...
    var bottom=$('.area').offset().top;
    var gotopBottom=bottom+400
    if(scrollTop>gotopBottom){
